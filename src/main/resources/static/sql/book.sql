...
DROP TABLE IF EXISTS SUMMERNOTE_IMAGE_T;
...
CREATE TABLE MEETING_T (
   ...
   MEETING_END_AT      DATETIME      NOT NULL,
   CATEGORY         VARCHAR(50)      NOT NULL,
    MEETING_CONTENT VARCHAR(3000) NOT NULL,
...
CREATE TABLE MEETING_MEMBER_T (
   ...
   MEETING_MEMBER_STATUS   INT   NULL,
...
CREATE TABLE OPEN_TALK_BOARD_DETAIL_T (
   ...
   BOARD_DETAIL_CONTENT_AT      DATETIME   NOT NULL,
...
ALTER TABLE CART_T ADD CONSTRAINT FK_BOOK_T_TO_CART_T_1 FOREIGN KEY (
   BOOK_NO
)
REFERENCES BOOK_T (
   BOOK_NO
...
ALTER TABLE OPEN_TALK_BOARD_DETAIL_T ADD CONSTRAINT FK_MEETING_T_TO_OPEN_TALK_BOARD_DETAIL_T_1 FOREIGN KEY (
   MEETING_NO
)
REFERENCES MEETING_T (
   MEETING_NO
...
INSERT INTO USER_T (USER_ID, USER_PASSWORD, USER_NAME, USER_EMAIL, AGREECODE, USER_GRADE)
   VALUES('admin', 'FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', 'admin', 'admin123@naver.com', 2, 2);
INSERT INTO USER_T (USER_ID, USER_PASSWORD, USER_NAME, USER_EMAIL, AGREECODE, USER_GRADE)
   VALUES('user1', '96CAE35CE8A9B0244178BF28E4966C2CE1B8385723A96A6B838858CDD6CA A1E', 'user1', 'user1123@naver.com', 2, 2);
INSERT INTO USER_T (USER_ID, USER_PASSWORD, USER_NAME, USER_EMAIL, AGREECODE, USER_GRADE)
   VALUES('user2', '8D969EEF6ECAD3C29A3A629280E686CF C3F5D5A86AFF3CA12 2 C923ADC6C92', 'user2', 'user2123@naver.com', 2, 2);
COMMIT;
